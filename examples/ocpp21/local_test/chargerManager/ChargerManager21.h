...
#ifndef CHARGERMANAGER21_H
#define CHARGERMANAGER21_H
...
/** @brief Minimal local-test charger manager */
class ChargerManager21 : public IChargerManager
{
  public:
    ChargerManager21();
    ~ChargerManager21() override;
