...
#ifndef OPENOCPP_OCPP21_MODEMTYPE_H
#define OPENOCPP_OCPP21_MODEMTYPE_H
...
/** @brief Defines parameters required for initiating and maintaining wireless communication with other devices.
 */
struct ModemType
{
    /** @brief This contains the ICCID of the modem’s SIM card. */
    ocpp::types::Optional<ocpp::types::CiStringType<20u>> iccid;
    /** @brief This contains the IMSI of the modem’s SIM card. */
...
#endif // OPENOCPP_OCPP21_MODEMTYPE_H