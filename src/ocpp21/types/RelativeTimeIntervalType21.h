...
#ifndef OPENOCPP_OCPP21_RELATIVETIMEINTERVALTYPE_H
#define OPENOCPP_OCPP21_RELATIVETIMEINTERVALTYPE_H
...
{
    /** @brief Start of the interval, in seconds from NOW. */
    int start;
...
#endif // OPENOCPP_OCPP21_RELATIVETIMEINTERVALTYPE_H