...
bool VariableMonitoringTypeConverter::fromJson(const rapidjson::Value&       json,
...
bool VariableMonitoringTypeConverter::toJson(const VariableMonitoringType& data, rapidjson::Document& json) 
{
    bool ret = true;
