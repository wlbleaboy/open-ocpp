                                      ...
                                      [[maybe_unused]] std::string& error_message)
{
    ...
    if (json.HasMember("chargingLimitSource"))
    {
        ...
        {
            std::string& item = data.chargingLimitSource.emplace_back();
            item = it->GetString();
        }
    }
...
bool ChargingProfileCriterionTypeConverter::toJson(const ChargingProfileCriterionType& data, rapidjson::Document& json) 
{
    ...
    if (!data.chargingLimitSource.empty())
    {
        ...
        for (const std::string& item : data.chargingLimitSource)
        {
            chargingLimitSource_json.PushBack(rapidjson::Value(item.c_str(), *allocator).Move(), *allocator);
        }
