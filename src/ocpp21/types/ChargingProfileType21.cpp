                                      ...
                                      [[maybe_unused]] std::string& error_message)
{
    ...
    // maxOfflineDuration
    extract(json, "maxOfflineDuration", data.maxOfflineDuration);
    ...
    extract(json, "invalidAfterOfflineDuration", data.invalidAfterOfflineDuration);

    // dynUpdateInterval
    extract(json, "dynUpdateInterval", data.dynUpdateInterval);

    // dynUpdateTime
    ret = ret && extract(json, "dynUpdateTime", data.dynUpdateTime, error_message);

    // priceScheduleSignature
    extract(json, "priceScheduleSignature", data.priceScheduleSignature);
...
bool ChargingProfileTypeConverter::toJson(const ChargingProfileType& data, rapidjson::Document& json) 
{
    ...
    // maxOfflineDuration
    fill(json, "maxOfflineDuration", data.maxOfflineDuration);
    ...
    // invalidAfterOfflineDuration
    fill(json, "invalidAfterOfflineDuration", data.invalidAfterOfflineDuration);

    // dynUpdateInterval
    fill(json, "dynUpdateInterval", data.dynUpdateInterval);

    // dynUpdateTime
    fill(json, "dynUpdateTime", data.dynUpdateTime);

    // priceScheduleSignature
    fill(json, "priceScheduleSignature", data.priceScheduleSignature);
