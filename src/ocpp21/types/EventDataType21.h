...
#ifndef OPENOCPP_OCPP21_EVENTDATATYPE_H
#define OPENOCPP_OCPP21_EVENTDATATYPE_H


#include "EventTriggerEnumType21.h"
#include "ComponentType21.h"
#include "EventNotificationEnumType21.h"
...
The Configuration Variable &lt;&lt;configkey-reporting-value-size,ReportingValueSize&gt;&gt; can be used to limit GetVariableResult.attributeValue, VariableAttribute.value and EventData.actualValue. The max size of these values will always remain equal. */
    ...
    /** @brief *(2.1)* Severity associated with the monitor in _variableMonitoringId_ or with the hardwired notification. */
    ocpp::types::Optional<int> severity;
    /** @brief  */
...
#endif // OPENOCPP_OCPP21_EVENTDATATYPE_H