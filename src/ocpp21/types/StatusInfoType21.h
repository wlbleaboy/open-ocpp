...
#ifndef OPENOCPP_OCPP21_STATUSINFOTYPE_H
#define OPENOCPP_OCPP21_STATUSINFOTYPE_H
...
struct StatusInfoType
{
    ...
    ocpp::types::Optional<ocpp::types::CiStringType<1024u>> additionalInfo;
    /** @brief  */
...
#endif // OPENOCPP_OCPP21_STATUSINFOTYPE_H