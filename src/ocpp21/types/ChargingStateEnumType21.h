...
#ifndef OPENOCPP_OCPP21_CHARGINGSTATEENUMTYPE_H
#define OPENOCPP_OCPP21_CHARGINGSTATEENUMTYPE_H
...
/** @brief Current charging state, is required when state
...
#endif // OPENOCPP_OCPP21_CHARGINGSTATEENUMTYPE_H