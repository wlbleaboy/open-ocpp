                                     ...
                                     std::string&                  error_message)
{
    ...
    if (json.HasMember("localAuthorizationList"))
    {
        ...
        ocpp::types::ocpp21::AuthorizationDataConverter localAuthorizationList_converter;
        for (auto it = localAuthorizationList_json.Begin(); ret && (it != localAuthorizationList_json.End()); ++it)
        {
            ocpp::types::ocpp21::AuthorizationData& item = data.localAuthorizationList.emplace_back();
    ...
    // updateType
    data.updateType = ocpp::types::ocpp21::UpdateEnumTypeHelper.fromString(json["updateType"].GetString());
...
bool SendLocalListReqConverter::toJson(const SendLocalListReq& data, rapidjson::Document& json) 
{
    ...
    if (!data.localAuthorizationList.empty())
    {
        ...
        for (const ocpp::types::ocpp21::AuthorizationData& item : data.localAuthorizationList)
        {
    ...
    // updateType
    fill(json, "updateType", ocpp::types::ocpp21::UpdateEnumTypeHelper.toString(data.updateType));
                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::SendLocalListStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool SendLocalListConfConverter::toJson(const SendLocalListConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::SendLocalListStatusEnumTypeHelper.toString(data.status));
