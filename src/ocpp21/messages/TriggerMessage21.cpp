                                     ...
                                     std::string&                  error_message)
{
    ...
    // requestedMessage
    data.requestedMessage = ocpp::types::ocpp21::MessageTriggerEnumTypeHelper.fromString(json["requestedMessage"].GetString());

    // customTrigger
    extract(json, "customTrigger", data.customTrigger);
...
bool TriggerMessageReqConverter::toJson(const TriggerMessageReq& data, rapidjson::Document& json) 
{
    ...
    // requestedMessage
    fill(json, "requestedMessage", ocpp::types::ocpp21::MessageTriggerEnumTypeHelper.toString(data.requestedMessage));

    // customTrigger
    fill(json, "customTrigger", data.customTrigger);
                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::TriggerMessageStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool TriggerMessageConfConverter::toJson(const TriggerMessageConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::TriggerMessageStatusEnumTypeHelper.toString(data.status));
