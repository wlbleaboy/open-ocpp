                                     ...
                                     std::string&                  error_message)
{
    ...
    // connectionData
    ocpp::types::ocpp21::NetworkConnectionProfileTypeConverter connectionData_converter;
                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::SetNetworkProfileStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool SetNetworkProfileConfConverter::toJson(const SetNetworkProfileConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::SetNetworkProfileStatusEnumTypeHelper.toString(data.status));
