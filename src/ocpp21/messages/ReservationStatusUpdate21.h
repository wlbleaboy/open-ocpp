...
#ifndef OPENOCPP_OCPP21_RESERVATIONSTATUSUPDATE_H
#define OPENOCPP_OCPP21_RESERVATIONSTATUSUPDATE_H
...
struct ReservationStatusUpdateReq
{
    ...
    int reservationId;
    /** @brief  */
    ocpp::types::ocpp21::ReservationUpdateStatusEnumType reservationUpdateStatus;
    /** @brief  */
...
#endif // OPENOCPP_OCPP21_RESERVATIONSTATUSUPDATE_H