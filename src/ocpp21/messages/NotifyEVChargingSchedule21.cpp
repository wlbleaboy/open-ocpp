                                     ...
                                     std::string&                  error_message)
{
    ...
    // chargingSchedule
    ocpp::types::ocpp21::ChargingScheduleTypeConverter chargingSchedule_converter;
    ...
    extract(json, "selectedChargingScheduleId", data.selectedChargingScheduleId);

    // powerToleranceAcceptance
    extract(json, "powerToleranceAcceptance", data.powerToleranceAcceptance);
...
bool NotifyEVChargingScheduleReqConverter::toJson(const NotifyEVChargingScheduleReq& data, rapidjson::Document& json) 
{
    ...
    // selectedChargingScheduleId
    fill(json, "selectedChargingScheduleId", data.selectedChargingScheduleId);

    // powerToleranceAcceptance
    fill(json, "powerToleranceAcceptance", data.powerToleranceAcceptance);
