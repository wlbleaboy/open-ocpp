                                     ...
                                     std::string&                  error_message)
{
    ...
    if (json.HasMember("eventData"))
    {
        ...
        ocpp::types::ocpp21::EventDataTypeConverter eventData_converter;
        for (auto it = eventData_json.Begin(); ret && (it != eventData_json.End()); ++it)
        {
            ocpp::types::ocpp21::EventDataType& item = data.eventData.emplace_back();
...
bool NotifyEventReqConverter::toJson(const NotifyEventReq& data, rapidjson::Document& json) 
{
    ...
    // eventData
        ...
        for (const ocpp::types::ocpp21::EventDataType& item : data.eventData)
        {
