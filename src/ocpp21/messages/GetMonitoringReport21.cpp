                                     ...
                                     std::string&                  error_message)
{
    ...
    if (json.HasMember("monitoringCriteria"))
    {
        ...
        {
            ocpp::types::ocpp21::MonitoringCriterionEnumType& item = data.monitoringCriteria.emplace_back();
            item = ocpp::types::ocpp21::MonitoringCriterionEnumTypeHelper.fromString(it->GetString());
        }
    }
...
bool GetMonitoringReportReqConverter::toJson(const GetMonitoringReportReq& data, rapidjson::Document& json) 
{
    ...
    if (!data.monitoringCriteria.empty())
    {
        ...
        for (const ocpp::types::ocpp21::MonitoringCriterionEnumType& item : data.monitoringCriteria)
        {
            monitoringCriteria_json.PushBack(rapidjson::Value(ocpp::types::ocpp21::MonitoringCriterionEnumTypeHelper.toString(item).c_str(), *allocator).Move(), *allocator);
        }
