                                     ...
                                     std::string&                  error_message)
{
    ...
    // connectorStatus
    data.connectorStatus = ocpp::types::ocpp21::ConnectorStatusEnumTypeHelper.fromString(json["connectorStatus"].GetString());
...
bool StatusNotificationReqConverter::toJson(const StatusNotificationReq& data, rapidjson::Document& json) 
{
    ...
    // connectorStatus
    fill(json, "connectorStatus", ocpp::types::ocpp21::ConnectorStatusEnumTypeHelper.toString(data.connectorStatus));
