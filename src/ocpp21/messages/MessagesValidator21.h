...
#ifndef OPENOCPP_OCPP21_MESSAGESVALIDATOR21_H
#define OPENOCPP_OCPP21_MESSAGESVALIDATOR21_H
...
/** @brief Stores all the needed OCPP 2.1 message validators */
class MessagesValidator21 : public IMessagesValidator
{
  public:
    /** @brief Constructor */
    MessagesValidator21();
    /** @brief Destructor */
    virtual ~MessagesValidator21();
...
#endif // OPENOCPP_OCPP21_MESSAGESVALIDATOR21_H
