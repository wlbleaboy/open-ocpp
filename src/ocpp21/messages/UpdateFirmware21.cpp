                                     ...
                                     std::string&                  error_message)
{
    ...
    // firmware
    ocpp::types::ocpp21::FirmwareTypeConverter firmware_converter;
                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::UpdateFirmwareStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool UpdateFirmwareConfConverter::toJson(const UpdateFirmwareConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::UpdateFirmwareStatusEnumTypeHelper.toString(data.status));
