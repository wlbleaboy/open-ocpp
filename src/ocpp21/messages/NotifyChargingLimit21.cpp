                                     ...
                                     std::string&                  error_message)
{
    ...
    if (json.HasMember("chargingSchedule"))
    {
        ...
        {
            ocpp::types::ocpp21::ChargingScheduleType& item = data.chargingSchedule.emplace_back();
    ...
    // chargingLimit
    ocpp::types::ocpp21::ChargingLimitTypeConverter chargingLimit_converter;
...
bool NotifyChargingLimitReqConverter::toJson(const NotifyChargingLimitReq& data, rapidjson::Document& json) 
{
    ...
    if (!data.chargingSchedule.empty())
    {
        ...
        for (const ocpp::types::ocpp21::ChargingScheduleType& item : data.chargingSchedule)
        {
