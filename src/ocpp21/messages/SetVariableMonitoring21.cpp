                                     ...
                                     std::string&                  error_message)
{
    ...
    if (json.HasMember("setMonitoringData"))
    {
        ...
        ocpp::types::ocpp21::SetMonitoringDataTypeConverter setMonitoringData_converter;
        for (auto it = setMonitoringData_json.Begin(); ret && (it != setMonitoringData_json.End()); ++it)
        {
            ocpp::types::ocpp21::SetMonitoringDataType& item = data.setMonitoringData.emplace_back();
...
bool SetVariableMonitoringReqConverter::toJson(const SetVariableMonitoringReq& data, rapidjson::Document& json) 
{
    ...
    // setMonitoringData
        ...
        for (const ocpp::types::ocpp21::SetMonitoringDataType& item : data.setMonitoringData)
        {
                                     ...
                                     std::string&                  error_message)
{
    ...
    if (json.HasMember("setMonitoringResult"))
    {
        ...
        ocpp::types::ocpp21::SetMonitoringResultTypeConverter setMonitoringResult_converter;
        for (auto it = setMonitoringResult_json.Begin(); ret && (it != setMonitoringResult_json.End()); ++it)
        {
            ocpp::types::ocpp21::SetMonitoringResultType& item = data.setMonitoringResult.emplace_back();
...
bool SetVariableMonitoringConfConverter::toJson(const SetVariableMonitoringConf& data, rapidjson::Document& json) 
{
    ...
    // setMonitoringResult
        ...
        for (const ocpp::types::ocpp21::SetMonitoringResultType& item : data.setMonitoringResult)
        {
            rapidjson::Document item_doc(rapidjson::kObjectType);
