                                     ...
                                     std::string&                  error_message)
{
    ...
    {
    ocpp::types::ocpp21::CertificateHashDataTypeConverter customerCertificate_converter;
                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::CustomerInformationStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool CustomerInformationConfConverter::toJson(const CustomerInformationConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::CustomerInformationStatusEnumTypeHelper.toString(data.status));
