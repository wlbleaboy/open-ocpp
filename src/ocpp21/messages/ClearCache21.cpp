                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::ClearCacheStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool ClearCacheConfConverter::toJson(const ClearCacheConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::ClearCacheStatusEnumTypeHelper.toString(data.status));
