                                     ...
                                     std::string&                  error_message)
{
    ...
    // certificateHashData
    ocpp::types::ocpp21::CertificateHashDataTypeConverter certificateHashData_converter;
                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::DeleteCertificateStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool DeleteCertificateConfConverter::toJson(const DeleteCertificateConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::DeleteCertificateStatusEnumTypeHelper.toString(data.status));
