                                     ...
                                     std::string&                  error_message)
{
    ...
    if (json.HasMember("certificateType"))
    {
        ...
        {
            ocpp::types::ocpp21::GetCertificateIdUseEnumType& item = data.certificateType.emplace_back();
            item = ocpp::types::ocpp21::GetCertificateIdUseEnumTypeHelper.fromString(it->GetString());
        }
    }
...
bool GetInstalledCertificateIdsReqConverter::toJson(const GetInstalledCertificateIdsReq& data, rapidjson::Document& json) 
{
    ...
    if (!data.certificateType.empty())
    {
        ...
        for (const ocpp::types::ocpp21::GetCertificateIdUseEnumType& item : data.certificateType)
        {
            certificateType_json.PushBack(rapidjson::Value(ocpp::types::ocpp21::GetCertificateIdUseEnumTypeHelper.toString(item).c_str(), *allocator).Move(), *allocator);
        }
                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::GetInstalledCertificateStatusEnumTypeHelper.fromString(json["status"].GetString());
    ...
    if (json.HasMember("certificateHashDataChain"))
    {
        ...
        ocpp::types::ocpp21::CertificateHashDataChainTypeConverter certificateHashDataChain_converter;
        for (auto it = certificateHashDataChain_json.Begin(); ret && (it != certificateHashDataChain_json.End()); ++it)
        {
            ocpp::types::ocpp21::CertificateHashDataChainType& item = data.certificateHashDataChain.emplace_back();
...
bool GetInstalledCertificateIdsConfConverter::toJson(const GetInstalledCertificateIdsConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::GetInstalledCertificateStatusEnumTypeHelper.toString(data.status));
    ...
    if (!data.certificateHashDataChain.empty())
    {
        ...
        for (const ocpp::types::ocpp21::CertificateHashDataChainType& item : data.certificateHashDataChain)
        {
