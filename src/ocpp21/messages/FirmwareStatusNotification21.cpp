                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::FirmwareStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool FirmwareStatusNotificationReqConverter::toJson(const FirmwareStatusNotificationReq& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::FirmwareStatusEnumTypeHelper.toString(data.status));
