                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::PublishFirmwareStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool PublishFirmwareStatusNotificationReqConverter::toJson(const PublishFirmwareStatusNotificationReq& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::PublishFirmwareStatusEnumTypeHelper.toString(data.status));
