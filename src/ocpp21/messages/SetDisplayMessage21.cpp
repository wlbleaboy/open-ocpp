                                     ...
                                     std::string&                  error_message)
{
    ...
    // message
    ocpp::types::ocpp21::MessageInfoTypeConverter message_converter;
                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::DisplayMessageStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool SetDisplayMessageConfConverter::toJson(const SetDisplayMessageConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::DisplayMessageStatusEnumTypeHelper.toString(data.status));
