                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::DataTransferStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool DataTransferConfConverter::toJson(const DataTransferConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::DataTransferStatusEnumTypeHelper.toString(data.status));
