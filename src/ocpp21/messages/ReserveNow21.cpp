                                     ...
                                     std::string&                  error_message)
{
    ...
    // connectorType
    extract(json, "connectorType", data.connectorType);
...
bool ReserveNowReqConverter::toJson(const ReserveNowReq& data, rapidjson::Document& json) 
{
    ...
    // connectorType
    fill(json, "connectorType", data.connectorType);
                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::ReserveNowStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool ReserveNowConfConverter::toJson(const ReserveNowConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::ReserveNowStatusEnumTypeHelper.toString(data.status));
