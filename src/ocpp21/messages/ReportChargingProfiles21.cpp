                                     ...
                                     std::string&                  error_message)
{
    ...
    // chargingLimitSource
    extract(json, "chargingLimitSource", data.chargingLimitSource);
    ...
    if (json.HasMember("chargingProfile"))
    {
        ...
        {
            ocpp::types::ocpp21::ChargingProfileType& item = data.chargingProfile.emplace_back();
...
bool ReportChargingProfilesReqConverter::toJson(const ReportChargingProfilesReq& data, rapidjson::Document& json) 
{
    ...
    // chargingLimitSource
    fill(json, "chargingLimitSource", data.chargingLimitSource);
    ...
    // chargingProfile
        ...
        for (const ocpp::types::ocpp21::ChargingProfileType& item : data.chargingProfile)
        {
