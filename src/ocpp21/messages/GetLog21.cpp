...
bool GetLogReqConverter::fromJson(const rapidjson::Value&       json,
                                     GetLogReq&                 data,
                                     ...
                                     std::string&                  error_message)
{
    ...
    // log
    ocpp::types::ocpp21::LogParametersTypeConverter log_converter;
    ret = ret && log_converter.fromJson(json["log"], data.log, error_code, error_message);

    // logType
    data.logType = ocpp::types::ocpp21::LogEnumTypeHelper.fromString(json["logType"].GetString());
...
bool GetLogReqConverter::toJson(const GetLogReq& data, rapidjson::Document& json) 
{
    ...
    // logType
    fill(json, "logType", ocpp::types::ocpp21::LogEnumTypeHelper.toString(data.logType));
...
bool GetLogConfConverter::fromJson(const rapidjson::Value&       json,
                                     GetLogConf&                 data,
                                     std::string&                  error_code,
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::LogStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool GetLogConfConverter::toJson(const GetLogConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::LogStatusEnumTypeHelper.toString(data.status));
