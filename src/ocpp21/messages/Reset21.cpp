...
/*
    Generated by json2cpp from : urn:OCPP:Cp:2:2025:1:ResetRequest
...
bool ResetReqConverter::fromJson(const rapidjson::Value&       json,
                                     ResetReq&                 data,
                                     ...
                                     std::string&                  error_message)
{
    ...
    // type
    data.type = ocpp::types::ocpp21::ResetEnumTypeHelper.fromString(json["type"].GetString());
...
bool ResetReqConverter::toJson(const ResetReq& data, rapidjson::Document& json) 
{
    ...
    // type
    fill(json, "type", ocpp::types::ocpp21::ResetEnumTypeHelper.toString(data.type));
...
bool ResetConfConverter::fromJson(const rapidjson::Value&       json,
                                     ResetConf&                 data,
                                     std::string&                  error_code,
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::ResetStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool ResetConfConverter::toJson(const ResetConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::ResetStatusEnumTypeHelper.toString(data.status));
