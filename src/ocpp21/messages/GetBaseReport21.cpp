                                     ...
                                     std::string&                  error_message)
{
    ...
    // reportBase
    data.reportBase = ocpp::types::ocpp21::ReportBaseEnumTypeHelper.fromString(json["reportBase"].GetString());
...
bool GetBaseReportReqConverter::toJson(const GetBaseReportReq& data, rapidjson::Document& json) 
{
    ...
    // reportBase
    fill(json, "reportBase", ocpp::types::ocpp21::ReportBaseEnumTypeHelper.toString(data.reportBase));
