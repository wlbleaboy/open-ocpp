                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::UploadLogStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool LogStatusNotificationReqConverter::toJson(const LogStatusNotificationReq& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::UploadLogStatusEnumTypeHelper.toString(data.status));
