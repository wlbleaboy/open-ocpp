                                     ...
                                     std::string&                  error_message)
{
    ...
    {
    ocpp::types::ocpp21::ClearChargingProfileTypeConverter chargingProfileCriteria_converter;
    ret = ret && chargingProfileCriteria_converter.fromJson(json["chargingProfileCriteria"], data.chargingProfileCriteria, error_code, error_message);
    }
                                     ...
                                     std::string&                  error_message)
{
    ...
    // status
    data.status = ocpp::types::ocpp21::ClearChargingProfileStatusEnumTypeHelper.fromString(json["status"].GetString());
...
bool ClearChargingProfileConfConverter::toJson(const ClearChargingProfileConf& data, rapidjson::Document& json) 
{
    ...
    // status
    fill(json, "status", ocpp::types::ocpp21::ClearChargingProfileStatusEnumTypeHelper.toString(data.status));
