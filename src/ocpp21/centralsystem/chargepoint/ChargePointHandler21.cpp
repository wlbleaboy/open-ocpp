                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - BatterySwap requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onBatterySwap(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - BatterySwap handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - NotifyAllowedEnergyTransfer requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onNotifyAllowedEnergyTransfer(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - NotifyAllowedEnergyTransfer handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - NotifyDERAlarm requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onNotifyDERAlarm(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - NotifyDERAlarm handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - NotifyDERStartStop requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onNotifyDERStartStop(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - NotifyDERStartStop handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - NotifyPeriodicEventStream requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onNotifyPeriodicEventStream(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - NotifyPeriodicEventStream handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - NotifyPriorityCharging requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onNotifyPriorityCharging(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - NotifyPriorityCharging handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - NotifySettlement requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onNotifySettlement(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - NotifySettlement handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - NotifyWebPaymentStarted requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onNotifyWebPaymentStarted(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - NotifyWebPaymentStarted handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - PullDynamicScheduleUpdate requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onPullDynamicScheduleUpdate(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - PullDynamicScheduleUpdate handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - ReportDERControl requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onReportDERControl(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - ReportDERControl handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
                                         ...
                                         std::string&                                        error_message)
{
    ...
    LOG_INFO << "[" << m_identifier << "] - VatNumberValidation requested";

    // Notify request
    if (m_handler)
    {
        ret = m_handler->onVatNumberValidation(request, response, error_code, error_message);

        LOG_INFO << "[" << m_identifier << "] - VatNumberValidation handled";
    }
    else
    {
        error_code = ocpp::rpc::IRpc::RPC_ERROR_INTERNAL;
