...
MaintenanceManager21::MaintenanceManager21(IChargePointEventsHandler21&                    events_handler,
      ...
      m_firmware_request_id()
{
    ...
    msg_dispatcher.registerHandler(PUBLISHFIRMWARE_ACTION, *dynamic_cast<GenericMessageHandler<PublishFirmwareReq, PublishFirmwareConf>*>(this));
    msg_dispatcher.registerHandler(RESET_ACTION, *dynamic_cast<GenericMessageHandler<ResetReq, ResetConf>*>(this));
    msg_dispatcher.registerHandler(SETNETWORKPROFILE_ACTION, *dynamic_cast<GenericMessageHandler<SetNetworkProfileReq, SetNetworkProfileConf>*>(this));
    msg_dispatcher.registerHandler(UNLOCKCONNECTOR_ACTION, *dynamic_cast<GenericMessageHandler<UnlockConnectorReq, UnlockConnectorConf>*>(this));
    msg_dispatcher.registerHandler(UNPUBLISHFIRMWARE_ACTION, *dynamic_cast<GenericMessageHandler<UnpublishFirmwareReq, UnpublishFirmwareConf>*>(this));
    msg_dispatcher.registerHandler(UPDATEFIRMWARE_ACTION, *dynamic_cast<GenericMessageHandler<UpdateFirmwareReq, UpdateFirmwareConf>*>(this));
...
MaintenanceManager21::~MaintenanceManager21()
{
}

bool MaintenanceManager21::call(const FirmwareStatusNotificationReq& request, FirmwareStatusNotificationConf& response, std::string& error, std::string& message)
{
    return (m_msg_sender.call(FIRMWARESTATUSNOTIFICATION_ACTION, request, response, error, message) == CallResult::Ok);
}

bool MaintenanceManager21::call(const LogStatusNotificationReq& request, LogStatusNotificationConf& response, std::string& error, std::string& message)
{
    return (m_msg_sender.call(LOGSTATUSNOTIFICATION_ACTION, request, response, error, message) == CallResult::Ok);
}

bool MaintenanceManager21::call(const PublishFirmwareStatusNotificationReq& request, PublishFirmwareStatusNotificationConf& response, std::string& error, std::string& message)
{
    return (m_msg_sender.call(PUBLISHFIRMWARESTATUSNOTIFICATION_ACTION, request, response, error, message) == CallResult::Ok);
}

bool MaintenanceManager21::notifyFirmwareUpdateStatus(FirmwareStatusEnumType status, const Optional<int>& request_id)
{
...
bool MaintenanceManager21::notifyLogStatus(UploadLogStatusEnumType status, const Optional<int>& request_id)
{
...
bool MaintenanceManager21::notifyPublishFirmwareStatus(PublishFirmwareStatusEnumType status,
...
bool MaintenanceManager21::onTriggerMessage(MessageTriggerEnumType message, const Optional<EVSEType>& evse)
{
    (void)evse;
...
bool MaintenanceManager21::handleMessage(const GetLogReq& request,
                               GetLogConf&      response,
...
bool MaintenanceManager21::handleMessage(const PublishFirmwareReq& request,
...
bool MaintenanceManager21::handleMessage(const ResetReq& request,
                               ResetConf&      response,
                               std::string&    error_code,
                               std::string&    error_message)
{
...
bool MaintenanceManager21::handleMessage(const SetNetworkProfileReq& request,
...
bool MaintenanceManager21::handleMessage(const UnlockConnectorReq& request,
...
bool MaintenanceManager21::handleMessage(const UnpublishFirmwareReq& request,
...
bool MaintenanceManager21::handleMessage(const UpdateFirmwareReq& request,
...
void MaintenanceManager21::processUpdateFirmware(std::string           location,
                                                 std::string           local_firmware_file,
